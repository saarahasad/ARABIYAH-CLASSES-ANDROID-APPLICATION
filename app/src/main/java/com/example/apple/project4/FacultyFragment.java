...
public class FacultyFragment extends Fragment {
    ...
    private facultyfragmentadapter madapter;

    static View.OnClickListener myOnClickListener;
    private static ArrayList<Integer> removedItems;

    ViewGroup rootView;
    String[] coursename={"Safwat Badawy Tantawy","Nahed Eid","Salma Abd Al-lateef","Alshaymaa Mohammad","Marwa Abd Alhady"};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new facultyfragmentadapter(data, getContext());
        ...
        adapter = new facultyfragmentadapter(data, mcontext);
        recyclerView.setAdapter(adapter);
        return rootView;
    }
