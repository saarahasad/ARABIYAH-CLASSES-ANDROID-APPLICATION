...
public class TestimonialFragment extends Fragment {
    ...
    private testimonialfragmentadapter madapter;

    static View.OnClickListener myOnClickListener;
    private static ArrayList<Integer> removedItems;

    ViewGroup rootView;
    String[] coursename={"Farha - India","Nikita - India","Abdulqader haro - USA"};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new testimonialfragmentadapter(data, getContext());
        ...
        adapter = new testimonialfragmentadapter(data, mcontext);
        recyclerView.setAdapter(adapter);
        return rootView;
    }
