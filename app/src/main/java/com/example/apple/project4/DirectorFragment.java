...
public class DirectorFragment extends Fragment {
    ...
    private directorfragmentadapter madapter;

    static View.OnClickListener myOnClickListener;
    private static ArrayList<Integer> removedItems;

    ViewGroup rootView;
    String[] coursename={"About","Qualifications","Books","Student Testimonials","Recommendations"};
